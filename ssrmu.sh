...
Download_SSR(){
	cd "/usr/local"
	wget -N --no-check-certificate "https://github.com/iMusi/shadowsocksr/archive/manyuser.zip"
	#git config --global http.sslVerify false
	#env GIT_SSL_NO_VERIFY=true git clone -b manyuser https://github.com/iMusi/shadowsocksr.git
